package com.github.leomauricio7.auth;

import com.github.leomauricio7.auth.entity.Permission;
import com.github.leomauricio7.auth.entity.User;
import com.github.leomauricio7.auth.repository.PermissionRepository;
...
public class AuthApplication {
    ...
    // usando commandLiner para criar um usuario/permissao para teste
    @Bean
    ...
    private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
        ...
        User find = userRepository.findByUserName("lmauricio");
        if (find == null) {
